...
\begin{figure}
	...
	\label{fig:residualZScoreMontage}
		...
		\caption[Residual SSD Montage.]{shows a webcam scene image, the reconstruction of that image from a PCA basis, and the residual image.}
\end{figure}
...
\begin{figure}
	...
	\label{fig:severalVarianceImages}
		...
		\caption[Residual Z-Score Montage.]{Figure \ref{fig:severalVarianceImages} show a webcam scene image, the reconstruction of that image from a PCA basis, and the residual image.}
\end{figure}
...
\begin{figure}
	\centering
	\subfigure[]{
		\includegraphics[width=.6\textwidth]{figures/highestKurtosis.jpg}
	\label{fig:highestKurtosis}
	}
	
	\subfigure[]{
		\includegraphics[width=.6\textwidth]{figures/highestSkewness.jpg}
	\label{fig:highestSkewness}
	}
