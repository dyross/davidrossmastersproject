...
\begin{figure}[h]
	\centering
	\subfigure[]{
		\includegraphics[width=0.8\textwidth]{figures/194cars.jpg}
	\label{fig:carsNoGradient}
	}
	\subfigure[]{
		\includegraphics[width=0.8\textwidth]{figures/194carsGradient.jpg}
...
\begin{figure}
	...
	\subfigure[]{
		\includegraphics[width=.8\textwidth]{figures/vectorMagnitudeMontage.jpg}
...
\begin{figure}
	\centering
	\subfigure[]{
		\includegraphics[width=.7\textwidth]{figures/severalHists2.jpg}
	\label{fig:severalHistsPlot}
	}
	
	\subfigure[]{
		\includegraphics[width=.7\textwidth]{figures/severalHistsReconstruction.jpg}
